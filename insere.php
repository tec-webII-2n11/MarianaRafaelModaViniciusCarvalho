<?php
	...
	if (isset($concluir)){
		echo "SUBMIT CONCLUIR";
	}
	if (isseT($entrar)){
		echo "SUBMIT ENTRAT";
	}
	if (isset($concluir) && !isset($entrar)){
    if (($nome == "") or ($email == "") or ($tia == "") or ($usuario_cad == "") or ($senha_cad1 == "") or ($senha_cad2 == "")) {
    ?>	
		<html>
			<head>
				<meta charset="UTF-8"/>
			...
			<body style="background-image:url(imagens/fundo.jpg);background-size:auto;">
		        ...
		        <p>Por favor, preencha todos os campos!</p>
		            ...
		            <input type="button" value="Login" id="login" onclick="logar()" class="invisible">
		            <input type="button" value="Cadastre-se" id="cadastrar" onclick="toninho()" class="invisible">
		            ...
		            <input name="Entrar" type="button" value="Entrar" id="entrar" class="invisible" onclick="location.href=#">
		            <input name="nome" type="text" id="nome" placeholder="Nome" value = <?php echo $nome ?>>
		            <input name="email" type="email" id="email" placeholder="E-mail" value = <?php echo $email ?>>
		            <input name="tia" type="text" id="tia" placeholder="TIA" value = <?php echo $tia ?>>
		            <input name="usuario_cad" type="text" id="usuario_cad" maxlength="12" placeholder="Usuário" value = <?php echo $usuario_cad ?>>
		            <input name="senha_cad1" type="password" id="senha_cad1" maxlength="12" placeholder="Senha">
		            <input name="senha_cad2" type="password" id="senha_cad2" maxlength="12" placeholder="Confirme sua senha">
		            <input name="concluir" type="submit" id="concluir" value="Concluir">
		            <input name="limpar" type="reset" id="limpar" value="Limpar">
		            </form>
		            <a href="index.php"><img id="voltar" src="imagens/back.png" alt="Voltar" width="42" height="21" style="margin-top: 15px;"/></a>    
		        </article>
		        </div>
		        <div style="clear:both"></div>
    ...
    <html>
			...
			<body style="background-image:url(imagens/fundo.jpg);background-size:auto;">
		        ...
		        <h2>Entre ou Cadastre-se</h2>
		        <p>Avalie e confira as opiniões de outros alunos!</p>
		        <p>As senhas digitadas são diferentes! Por favor, digite novamente.</p>
		        	<form method="post" action="insere.php" id="formlogin" name="formlogin">
		            <input type="button" value="Login" id="login" onclick="logar()" class="invisible">
		            <input type="button" value="Cadastre-se" id="cadastrar" onclick="toninho()" class="invisible">
					<input type="text" name="usuario" id="usuario" class="invisible" placeholder="Usuário">
    ...
    $senha_cript = sha1($senha_cad1);
    
    include "conecta_mysql.php";
    
    $query = "INSERT INTO usuarios (nome, email, tia, usuario, senha)
		   VALUES ('$nome', '$email', $tia, '$usuario_cad', '$senha_cript')";
	
	$resultado = mysqli_query($conexao, $query) or die ("Não foi possível executar o comando: ".mysqli_error());
	...
	if ($resultado == TRUE){
	   ...
	   <html>
			...
			<body style="background-image:url(imagens/fundo.jpg);background-size:auto;">
		        ...
		        <p>Volte para a página inicial para realizar seu login.</p>
		        <a href="index.php"><img id="voltar" src="imagens/back.png" alt="Voltar" width="42" height="21" style="margin-top: 15px;"/></a>    
		        </article>
		        </div>
		        <div style="clear:both"></div>
	...
	} elseif (isset($entrar) && !(isset($concluir))) {
	if (($usuario == "") or ($senha == "")) {
    ?>	
		<html>
			<head>
			...
			<body style="background-image:url(imagens/fundo.jpg);background-size:auto;">
		        ...
		        <p>Por favor, preencha todos os campos!</p>
		            ...
		            <input type="button" value="Login" id="login" onclick="logar()" class="invisible">
		            <input type="button" value="Cadastre-se" id="cadastrar" onclick="toninho()" class="invisible">
					<input type="text" name="usuario" id="usuario" placeholder="Usuário" value = <?php echo $usuario ?>>
					<input type="password" name="senha" id="senha" placeholder="Senha">
		            <input name="Entrar" type="submit" value="Entrar" id="entrar" class="invisible" onclick="href=#">
		            <input name="nome" type="text" id="nome" placeholder="Nome" class="invisible">
		            <input name="email" type="email" id="email" placeholder="E-mail" class="invisible">
		            <input name="tia" type="text" id="tia" placeholder="TIA" class="invisible">
		            <input name="usuario_cad" type="text" id="usuario_cad" maxlength="12" placeholder="Usuário" class="invisible">
		            <input name="senha_cad1" type="password" id="senha_cad1" maxlength="12" placeholder="Senha">
		            <input name="senha_cad2" type="password" id="senha_cad2" maxlength="12" placeholder="Confirme sua senha" class="invisible">
	...
	$resultado = mysqli_query($conexao, $query) or die ("Não foi possível executar o comando: ".$conexao->error);
	
	if ($resultado) {
		while ($row = mysqli_fetch_array($resultado)){
			$senha_banco = $row["senha"];
		}
		if ($senha_cript == $senha_banco) {
